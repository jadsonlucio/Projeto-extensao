...
to change width of column drag boundary
        ...
        style.configure("Custom.Treeview.Heading",
                        background="gray", foreground="black",font=("Arial",15),relief="groove",borderwidth=6,bordercolor="blue")
        style.map("Custom.Treeview.Heading",
                  relief=[('active', 'groove'), ('pressed', 'sunken')])
        style.configure("Custom.Treeview",
                        background="gray", foreground="blue",font=("Arial",15), relief="groove", borderwidth=6)
        self.tree = ttk.Treeview(columns=car_header, show="headings",style="Custom.Treeview")
...
car_list = [
('Hyundaidsahudoashudsahdasudhsuad', 'brakes') ,
('Honda', 'light') ,
('Lexus', 'battery') ,
('Benz', 'wiper') ,
('Ford', 'tire') ,
